...
public class PantallaInicio_Gerente extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PantallaInicio_Gerente frame = new PantallaInicio_Gerente();
	...
	public PantallaInicio_Gerente() {
		...
		lblNewLabel_6.setIcon(new ImageIcon(PantallaInicio_Gerente.class.getResource("/imagenes/ProductorSeguro.png")));
		...
		JLabel lblNewLabel_5_1 = new JLabel("Gerente\r\n");
		...
		btnNewButton.setIcon(new ImageIcon(PantallaInicio_Gerente.class.getResource("/imagenes/personita.png")));
		...
		btnNewButton_2.setIcon(new ImageIcon(PantallaInicio_Gerente.class.getResource("/imagenes/engranajesChicos.png")));
		...
		btnNewButton_1.setIcon(new ImageIcon(PantallaInicio_Gerente.class.getResource("/imagenes/salir.png")));
		...
		lblNewLabel_4.setIcon(new ImageIcon(PantallaInicio_Gerente.class.getResource("/imagenes/Documento.png")));
		...
		JLabel lblNewLabel_5 = new JLabel("Reportes");
		...
		JButton btnActualizarFactoresDe_1 = new JButton("Generar listado de propuestas de Renovación");
		...
		JButton btnActualizarFactoresDe = new JButton("Generar informe de resultado mensual");
